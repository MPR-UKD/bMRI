...
if __name__ == "__main__":
    ...
    t1rho = T1rho(
        ...
        config={"T1": 800, "TR": 3500, "alpha": 15, "TE": 5.78, "T2star": 10},
    )
    ...
    # TEs = ................. ms
    ###################################################################################################################
    t2 = T2_T2star(dim=3, boundary=([0.2, 5, -0.1], [1, 80, 0.1]))
